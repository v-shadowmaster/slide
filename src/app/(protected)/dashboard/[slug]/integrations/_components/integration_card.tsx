...
export default function IntegrationCard({ title, description, icon, strategy }: Props) {
    // WIP : wire up fetching data and get the integration from the db(oauth)
    return <div className="border border-border rounded-xl gap-x-5 p-5 flex items-center justify-between bg-card">
