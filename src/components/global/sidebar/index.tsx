...
export default function Sidebar({ slug }: Props) {
  ...
  return (
    <div
      className={`w-[250px] border-[1px]  raidal fixed left-0 lg:inline-block border-[#545454] bg-gradient-to-b from-[#768BDD] via-[#1A1A1A] to-[#768BDD] hidden bottom-0 top-0 m-3 rounded-3xl overflow-hidden`}
    >
